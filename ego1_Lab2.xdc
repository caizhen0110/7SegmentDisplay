...
///////////////////////////////8个数码管位选信号/////////////////////////////////
#seg_cs_pin[0]~seg_cs_pin[7]，選擇需要的改成邏輯電路圖上的變數名稱。
#決定要顯示在7段顯示器 DK1~DK8 的哪個位置
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports {bright_pos}]
...
set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports {bright_sop}]

///////////////////////////////////数码管段选信号//////////////////////////////////
#seg_data_0_pin[0]~seg_data_0_pin[7]，選擇需要的改成邏輯電路圖上的變數名稱。
#seg_data_1_pin[0]~seg_data_1_pin[7]，選擇需要的改成邏輯電路圖上的變數名稱。
#若兩區設定相同變數，則會顯示在DK5-DK8的區域。

#控制DK1-DK4中的ABCDEFG
set_property -dict {PACKAGE_PIN B4 IOSTANDARD LVCMOS33} [get_ports {a_POS}]
set_property -dict {PACKAGE_PIN A4 IOSTANDARD LVCMOS33} [get_ports {b_POS}]
set_property -dict {PACKAGE_PIN A3 IOSTANDARD LVCMOS33} [get_ports {c_POS}]
set_property -dict {PACKAGE_PIN B1 IOSTANDARD LVCMOS33} [get_ports {d_POS}]
set_property -dict {PACKAGE_PIN A1 IOSTANDARD LVCMOS33} [get_ports {e_POS}]
set_property -dict {PACKAGE_PIN B3 IOSTANDARD LVCMOS33} [get_ports {f_POS}]
set_property -dict {PACKAGE_PIN B2 IOSTANDARD LVCMOS33} [get_ports {g_POS}]
set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS33} [get_ports {seg_data_0_pin[7]}]

#控制DK5-DK8中的ABCDEFG
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports {A_SOP}]
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports {B_SOP}]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports {C_SOP}]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports {D_SOP}]
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports {E_SOP}]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports {F_SOP}]
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33} [get_ports {G_SOP}]
